...
if [ $day == "Monday" ]
then
  title="Monday might be Awful"

elif [ $day == "Tuesday"  ]
then
  title="Tuesday might be working"

elif [ $day == "Wednesday" ]
then
  title="Wednesday might be sleeping"

elif [ $day == "Thursday" ]
then
  title="Thursday might be studying"

elif [ $day == "Friday" ]
then
  title="Friday is party day"

elif [ $day == "Saturday" ]
then
  title="Saturday might be in hangover"
