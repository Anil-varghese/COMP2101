...
then
  ...
  then
    ...
    echo "Wrong Password. Your third chance to enter Password:"
    read guessPassword
    ...
    then
      ...
      echo "Wrong Password. Your forth chance to enter Password:"
      read guessPassword
      ...
      then
        ...
        echo "Wrong Password. Your fifth chance to enter Password:"
        read guessPassword
